...
*/
/**************************************************************************/
// uint8_t Adafruit_NFCShield_I2C::mifareclassic_WriteNDEFURI(uint8_t sectorNumber, uint8_t uriIdentifier, const char * url, uint8_t hour )
uint8_t Adafruit_NFCShield_I2C::mifareclassic_WriteNDEFURI(uint8_t sectorNumber, uint8_t uriIdentifier, const char * url)
{
  ...
  // uint8_t sectorbuffer4[16] = {hour, 0xF7, 0xD3, 0xF7, 0xD3, 0xF7, 0x7F, 0x07, 0x88, 0x40, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
